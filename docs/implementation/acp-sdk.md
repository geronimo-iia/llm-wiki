...
|-------|---------|--------|
| `agent-client-protocol-rmcp` | Bridge rmcp `ServerHandler` into ACP sessions | Deferred — Proxy-only, see [rmcp-streamable-http.md](../decisions/rmcp-streamable-http.md) |
